...
To distinguish these explanations from their psychologically plausible counterparts defined in the previous section, we will henceforth refer to these solutions as \textit{computationally plausible \glspl{CFE}}.
...
Note that pack size can never shrink below 2 to circumvent the pack vanishing completely.
\textbf{HERE: FIGURE OF DATA DISTRIBUTION?}
