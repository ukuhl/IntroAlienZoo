...
Another, straight forward approach is to limit the set of possible counterfactuals to the training data~\citep{poyiadzi_face_2019} -- in the current work, we follow this approach when providing \textit{computationally plausible \glspl{CFE}}.
