...
# Where's the data
demo_source = list.files(pattern="DemographicsSim.csv")
...
* We have age information for `r N_P_age` users in the plausible and `r N_C_age` users in the closest group.
...
* We have age information for `r N_P_gender` users in the plausible and `r N_C_gender` users in the closest group.
...
# save
ggsave("Figures/H2.1_figure2_UserResponses_violin.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.1_figure2_UserResponses_stackedBar.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.2_figure2_UserResponses_violin.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.2_figure2_UserResponses_stackedBar.pdf",width = 6, height = 2,)
...
# save
ggsave("Figures/H3_figure2_UserResponses_violin.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H3_figure2_UserResponses_stackedBar.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H4_figure2_UserResponses_violin.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H4_figure2_UserResponses_stackedBar.pdf",width = 6, height = 2,)
...
Item 7: "I found inconsistencies in the feedback on what choice would have led to a better result."
...
Expl_FreqUserResponses = ggplot(data=df_survey_Inconsist_summary, aes(x=responseNo,fill = group)) + 
  geom_bar(aes(y = SumChecks),stat="identity",position = position_dodge(preserve = "single"))+
  facet_wrap(vars(itemNo),nrow = 2, ncol = 1,labeller=as_labeller(c(`7`="\"I found inconsistencies.\"")))+
...
# save
ggsave("Figures/Expl_figure2_UserResponses_violin.pdf",width = 6, height = 4,)
