...
H1.1_p_ShubsPerTrial_summary_anno1 = H1.1_p_ShubsPerTrial_summary+
  ...
  geom_text(x = 8,  y = 25.5, label = "***", colour = "black")+
  geom_segment(aes(x = 9, y = 21, xend = 9, yend = 29.5),colour = "black", size=0.2) +
  geom_segment(aes(x = 9, y = 30.5, xend = 9, yend = 38.5),colour = "black", size=0.2) +
  geom_text(x = 9,  y = 29.5, label = "***", colour = "black")+
  geom_segment(aes(x = 10, y = 21, xend = 10, yend = 30.5),colour = "black", size=0.2) +
  geom_segment(aes(x = 10, y = 31.5, xend = 10, yend = 42),colour = "black", size=0.2) +
  geom_text(x = 10,  y = 30.5, label = "***", colour = "black")+
  geom_segment(aes(x = 11, y = 23, xend = 11, yend = 36.5),colour = "black", size=0.2) +
  geom_segment(aes(x = 11, y = 37.5, xend = 11, yend = 52),colour = "black", size=0.2) +
  geom_text(x = 11,  y = 36.5, label = "***", colour = "black")+
  geom_segment(aes(x = 12, y = 25, xend = 12, yend = 42.5),colour = "black", size=0.2) +
  geom_segment(aes(x = 12, y = 43.5, xend = 12, yend = 60.5),colour = "black", size=0.2) +
  geom_text(x = 12,  y = 42.5, label = "***", colour = "black")

# save
ggsave("Figures/H1.1_p_ShubsPerTrial_summary_anno1_IAZ_EXP2_FINAL.pdf",width = 5, height = 3,)
...
H1.2_figure1_RTData <- ggarrange(H1.2_p_RTPerTrial,H1.2_p_RTPerBlock,
                    ncol = 1, nrow = 2, heights=c(4,4), common.legend = TRUE)
# save
ggsave("Figures/H1.2_figure1_RTData_IAZ_EXP2_FINAL.pdf",width = 5, height = 4,)

# put all plots together
H1.2_figure1_RTData_summary <- ggarrange(H1.2_p_RTPerTrial_summary,H1.2_p_RTPerBlock_summary,
                    ncol = 1, nrow = 2, heights=c(4,4), common.legend = TRUE)
# save
ggsave("Figures/H1.2_figure1_RTData_summary_IAZ_EXP2_FINAL.pdf",width = 5, height = 4,)
...
Post-hoc analysis of the main effect of trial showed significant differences between trial 1 and all other trials (all t(451)>=3.432, p=0.0431 or lower, Cohen's d=0.7404 or higher), with the exception of trials 2 and 10.
...
H1.2_p_RTPerTrial_summary_anno <- ggplot(df_RTPerTrial_summary, aes(x=as.factor(TrialNr), y=mean/1000, group = group, color= group))+ 
  ...
  scale_fill_manual("Group", values=c(Ccol,Pcol), labels = c("Control", "CFE"))+
  theme(legend.position="bottom")+
  # FIRST COMPARISONS: trial 1 vs. all other trials except trials 2 and 10 (all p<0.045)
  geom_segment(aes(x = 1, y = 32000/1000, xend = 1, yend = 36500/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 3, y = 32000/1000, xend = 3, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 9, y = 32000/1000, xend = 9, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 11, y = 32000/1000, xend = 11, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 12, y = 32000/1000, xend = 12, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 3, y = 34000/1000, xend = 9, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 11, y = 34000/1000, xend = 12, yend = 34000/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 6, y = 34000/1000, xend = 6, yend = 35500/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 11.5, y = 34000/1000, xend = 11.5, yend = 35500/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 6, y = 35500/1000, xend = 11.5, yend = 35500/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 8.75, y = 35500/1000, xend = 8.75, yend = 36500/1000),colour = "black", size=0.2) +
  geom_segment(aes(x = 1, y = 36500/1000, xend = 8.75, yend = 36500/1000),colour = "black", size=0.2) +
  geom_text(x = 4,  y = 37000/1000, label = "*", colour = "black")

# save
ggsave("Figures/H1.2_p_RTPerTrial_summary_anno_IAZ_EXP2_FINAL.pdf",width = 5, height = 3,)
...
# Experiment 2: plants 2, and 4 were relevant:
...
# save
ggsave("Figures/H1.3_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H1.3_figure2_UserResponseMatches_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
* Is there a significant difference in terms of matches between plants judged as relevant and ground truth?: We compared number of matches for users in explanation condition (M = `r df_survey_relevantPlants_summary$mean[df_survey_relevantPlants_summary$group=="E"]`, SEM = `r df_survey_relevantPlants_summary$sem[df_survey_relevantPlants_summary$group=="E"]`) and users in the control condition (M = `r df_survey_relevantPlants_summary$mean[df_survey_relevantPlants_summary$group=="C"]`, SEM = `r df_survey_relevantPlants_summary$sem[df_survey_relevantPlants_summary$group=="C"]`) using a `r item1t` test. This showed
  ...
  + So NO! People receiving explanations could better identify relevant features.
...
H1.3_figure2_UserResponseMatches_anno = ggplot(df_survey_relevantPlants_plot, aes(x=group, y=mean, fill=group)) + 
  ...
  geom_segment(aes(x = 1, y = 3.5, xend = 1, yend = 4),colour = "black", size=0.2) +
  ...
  geom_text(x = 1.5,  y = 4.5, label = "n.s.", colour = "black")

# save
ggsave("Figures/H1.3_figure2_UserResponseMatches_anno_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H1_p_ShubsPerTrial_RTPerTrial_IAZ_EXP2_FINAL.pdf",width = 8,height = 3.5) #width = 7, height = 2,

# display
print("Summary plot for H1:")
...
# save
ggsave("Figures/H2.1_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H2.1_figure2_UserResponses_violin_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.1_figure2_UserResponses_stackedBar_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
anno_df <- data.frame(label = c("** (p=0.0013)", "* (p=0.0116)"),itemNo   = c(5, 6))
...
# save
ggsave("Figures/H2.1_figure2_UserResponses_stackedBar_anno_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.2_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H2.2_figure2_UserResponses_violin_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2.2_figure2_UserResponses_stackedBar_IAZ_EXP2_FINAL.pdf",width = 6, height = 2,)
...
anno_df <- data.frame(label = c("n.s. (p=.091)"),itemNo   = c(9))
H2.2_figure2_UserResponses_stackedBar_anno=H2.2_figure2_UserResponses_stackedBar + geom_text(
  data = anno_df, mapping = aes(x = Inf, y = -Inf, label = label), hjust = -0.1, vjust = 1.5, size=2, fontface = "italic")

# save
ggsave("Figures/H2.2_figure2_UserResponses_stackedBar_anno_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
p1_T1=H2.1_figure2_UserResponses_stackedBar_anno+facet_wrap(vars(itemNo),nrow = 1, ncol = 2,labeller=as_labeller(c(`5`="\"Feedback helped me.\"",`6`="\"I could use the feedback.\"")))+
  theme(panel.spacing = unit(1, "lines"),axis.title.x=element_blank())

p1_T1$labels$title=c()
...
p2_T1=H2.2_figure2_UserResponses_stackedBar_anno+theme(axis.title.y=element_blank(),
...
# save
ggsave("Figures/H2_p_UserJudgements_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,

H2_p_UserJudgements_T=ggarrange(p1_T1,p2_T1, ncol = 2, nrow = 1, widths=c(6,2.5), common.legend = TRUE, legend="bottom")

# save
ggsave("Figures/H2_p_UserJudgements_T_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,

# re-define without legend for later use
H2_p_UserJudgements_T=ggarrange(p1_T1,p2_T1, ncol = 2, nrow = 1, widths=c(6,2.5), legend="none")

# display
print("Summary plot H2:")
...
# save
ggsave("Figures/H3_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H3_figure2_UserResponses_violin_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H3_figure2_UserResponses_stackedBar_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
anno_df <- data.frame(label = c("n.s. (p=.050)","n.s. (p=.177)"),itemNo   = c(3,4))
H3_figure2_UserResponses_stackedBar_anno=H3_figure2_UserResponses_stackedBar + geom_text(
  data = anno_df, mapping = aes(x = Inf, y = -Inf, label = label), hjust = -0.1, vjust = 1.5, size=2, fontface = "italic")

# save
ggsave("Figures/H3_figure2_UserResponses_stackedBar_anno_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H4_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/H4_figure2_UserResponses_violin_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H4_figure2_UserResponses_stackedBar_IAZ_EXP2_FINAL.pdf",width = 6, height = 2,)
...
anno_df <- data.frame(label = c("n.s. (p=.334)"),itemNo   = c(10))
H4_figure2_UserResponses_stackedBar_anno=H4_figure2_UserResponses_stackedBar + geom_text(
  data = anno_df, mapping = aes(x = Inf, y = -Inf, label = label), hjust = -0.1, vjust = 1.5, size=2, fontface = "italic")

# save
ggsave("Figures/H4_figure2_UserResponses_stackedBar_anno_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
p1_T2=H3_figure2_UserResponses_stackedBar_anno+facet_wrap(vars(itemNo),nrow = 1, ncol = 2,labeller=as_labeller(c(`3`="\"I understood the feedback.\"",`4`="\"I needed support to understand.\"")))+
  theme(panel.spacing = unit(1, "lines"),axis.title.x=element_blank())
p1_T2$labels$title=c()
...
p2_T2=H4_figure2_UserResponses_stackedBar_anno+theme(title=element_blank(),
...
# save
ggsave("Figures/H3_p_UserJudgements_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,

H3_p_UserJudgements_T=ggarrange(p1_T2,p2_T2, ncol = 2, nrow = 1, widths=c(6,2.5), common.legend = TRUE, legend="bottom")
# save
ggsave("Figures/H3_p_UserJudgements_T_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,

# re-define without legend for later use
H3_p_UserJudgements_T=ggarrange(p1_T2,p2_T2, ncol = 2, nrow = 1, widths=c(6,2.5), legend="none")
...
# save
ggsave("Figures/Expl_figure1_UserResponses_IAZ_EXP2_FINAL.pdf",width = 5, height = 6,)
...
# save
ggsave("Figures/Expl_figure2_UserResponses_violin_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/Expl_figure2_UserResponses_stackedBar_IAZ_EXP2_FINAL.pdf",width = 6, height = 2,)
...
anno_df <- data.frame(label = c("n.s. (p=.786)"),itemNo   = c(8))
Expl_figure2_UserResponses_stackedBar_anno=Expl_figure2_UserResponses_stackedBar + geom_text(
  data = anno_df, mapping = aes(x = Inf, y = -Inf, label = label), hjust = -0.1, vjust = 1.5, size=2, fontface = "italic")

# save
ggsave("Figures/Expl_figure2_UserResponses_stackedBar_anno_IAZ_EXP2_FINAL.pdf",width = 6, height = 4,)
...
# save
ggsave("Figures/H2_H3_expl_survey_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,
...
ggsave("Figures/H2_H3_expl_survey_T_IAZ_EXP2_FINAL.pdf",width = 8,height = 4) #width = 7, height = 2,
...
#Check its existence
if (file.exists(paste("BivariateStats_IAZ_EXP2_FINAL.csv",sep=""))) {
  #Delete file if it exists
  file.remove(paste("BivariateStats_IAZ_EXP2_FINAL.csv",sep=""))
}

tmpFile=file(paste("BivariateStats_IAZ_EXP2_FINAL.csv",sep=""), "w+")
