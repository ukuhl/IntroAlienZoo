...
if __name__ == "__main__":
    ...
    # load data
    df = pd.read_csv("AlienZooDataSet3.csv")
    ...
    # save trained model
    print("save model")
    torch.save(net,'PyTorchNetDataSet3_Regression_2000epochs_SquaredError.joblib')
    # ### ### ### ###

    # load the model
    print("load model")
    net = torch.load('PyTorchNetDataSet3_Regression_2000epochs_SquaredError.joblib')
