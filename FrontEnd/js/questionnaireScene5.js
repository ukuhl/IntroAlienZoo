...
class QuestionnaireScene4 extends Phaser.Scene {
	...
	create() {
		...
		// option 6
		this.add.text(window.innerWidth * 0.65, window.innerHeight * 0.225, 'Not listed', { fontFamily: 'Arial', fontSize: '17px', color: '#000000' });
		...
		// Don't know
		this.add.text(window.innerWidth * 0.755, window.innerHeight * 0.225, 'I prefer not to answer.', { fontFamily: 'Arial', fontSize: '17px', color: '#000000' });
